    ...
    <div class="container">
        ...
        <div class="col-1">
            <div class="form-container">
                ...
                <form method="post" action="login1_submit.php">
                ...
                <p class="sign-up-label">
                  ...
                  Don't have an account?<span class="sign-up-link"><a href="jobseekerdetails.php"><button>Sign up</span>
                </button></a></p>
        ...
        <div class="col-2">
            <div class="form-container">
                ...
                <form method="post" action="login_submit.php">
                    <input type="text" name="email" placeholder="Job Seeker Email">
                    <input type="password" name="password" placeholder="Password">
                    <p class="page-link">
                        <span class="page-link-label">Forgot Password?</span>
                    </p>
